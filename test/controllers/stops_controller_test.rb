...
class StopsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create stop" do
    assert_difference('Stop.count') do
      post stops_url, params: { stop: { hour_arrival: @stop.hour_arrival, latitude: @stop.latitude, load: @stop.load, longitude: @stop.longitude, route_id: @stop.route_id } }
    end
  ...
  test "should update stop" do
    patch stop_url(@stop), params: { stop: { hour_arrival: @stop.hour_arrival, latitude: @stop.latitude, load: @stop.load, longitude: @stop.longitude, route_id: @stop.route_id } }
